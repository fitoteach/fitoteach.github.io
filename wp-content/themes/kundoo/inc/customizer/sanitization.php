 ...
 */
function kundoo_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function kundoo_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function kundoo_sanitize_html( $html ) {
 ...
 */
function kundoo_sanitize_image( $image, $setting ) {
 ...
 */
function kundoo_sanitize_nohtml( $nohtml ) {
 ...
 */
function kundoo_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function kundoo_sanitize_range_value( $number, $setting ) {
 ...
 */
function kundoo_sanitize_select( $input, $setting ) {
 ...
 */
function kundoo_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function kundoo_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function kundoo_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
