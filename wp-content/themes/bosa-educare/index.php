...
?>
	...
	<div id="content" class="site-content">
		<div class="container">
			...
			<?php bosa_educare_blog_advertisement_banner(); ?>
			...
			<!--Blog Advertisement-->
			<?php get_template_part( 'template-parts/advertisements/advertisements' ); ?>
							...
							<?php
								if( !get_theme_mod( 'disable_pagination', false ) ):
									the_posts_pagination( array(
										...
										'next_text' => '<span>'.esc_html__( 'Next', 'bosa-educare' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Next page', 'bosa-educare' ) . '</span>',
										'prev_text' => '<span>'.esc_html__( 'Prev', 'bosa-educare' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Previous page', 'bosa-educare' ) . '</span>',
										'before_page_number' => '<span class="meta-nav screen-reader-text">' . esc_html__( 'Page', 'bosa-educare' ) . ' </span>',
									));
								endif;
								wp_reset_postdata();
							?>
