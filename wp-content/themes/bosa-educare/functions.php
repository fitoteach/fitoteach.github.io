...
if ( ! function_exists( 'bosa_educare_enqueue_styles' ) ) :
	/**
	 * @since Bosa Educare 1.0.0
	 */
	function bosa_educare_enqueue_styles() {
        require_once get_theme_file_path ( 'inc/wptt-webfont-loader.php');

		wp_enqueue_style( 'bosa-educare-style-parent', get_template_directory_uri() . '/style.css',
			array(
				'bootstrap',
				'slick',
				'slicknav',
...
add_action( 'wp_enqueue_scripts', 'bosa_educare_enqueue_styles', 10 );

/**
* Registers menu location. 
* @since Bosa Educare 1.0.0
*/
function bosa_educare_menu_register(){
    register_nav_menu(
        'menu-4', esc_html__( 'Category Menu', 'bosa-educare' )
    );
}
add_action( 'after_setup_theme', 'bosa_educare_menu_register' );

/**
* Add cart link
* @since Bosa Educare 1.0.0
*/
if ( !function_exists( 'bosa_educare_cart_link' ) ) {
    function bosa_educare_cart_link() {
        ?>	
...
* @since Bosa Educare 1.0.0
*/
if ( !function_exists( 'bosa_educare_header_cart' ) ) {
    function bosa_educare_header_cart() {
        ?>
            <div class="header-cart">
                <div class="header-cart-block">
                    <div class="header-cart-inner">
                        <?php bosa_educare_cart_link(); ?>
...
* @since Bosa Educare 1.0.0
*/
if ( !function_exists( 'bosa_educare_header_add_to_cart_fragment' ) ) {
    function bosa_educare_header_add_to_cart_fragment( $fragments ) {
        ob_start();
        bosa_educare_cart_link();
        $fragments['a.cart-contents'] = ob_get_clean();
        return $fragments;
    }
    add_filter( 'woocommerce_add_to_cart_fragments', 'bosa_educare_header_add_to_cart_fragment' );
}
...
* @since Bosa Educare 1.0.0
*/
if ( !function_exists( 'bosa_educare_head_wishlist' ) ) {
    function bosa_educare_head_wishlist() {
            ...
            <div class="header-wishlist">
                <a href="<?php echo esc_url( $wishlist_url ); ?>">
                    ...
                    <span class="info-tooltip">
                        <?php esc_html_e( 'Wishlist', 'bosa-educare' ); ?>
                    </span>
                </a>
            </div>
            <?php
...
* @since Bosa Educare 1.0.0
*/
if (!function_exists( 'bosa_educare_head_compare' ) ) {
    function bosa_educare_head_compare() {
        if ( function_exists( 'yith_woocompare_constructor' ) ) {
            ...
            <div class="header-compare">
                <a class="compare added" rel="nofollow" href="<?php echo esc_url( $yith_woocompare->obj->view_table_url() ); ?>">
                    ...
                    <span class="info-tooltip">
                        <?php esc_html_e( 'Compare', 'bosa-educare' ); ?>
                    </span>
                </a>
            </div>
            <?php
...
* @since Bosa Educare 1.0.0
*/
if ( !function_exists( 'bosa_educare_my_account' ) ) {
    function bosa_educare_my_account() {
            ...
            <div class="header-my-account">
                <div class="header-login"> 
                    <a href="<?php echo esc_url( get_permalink( get_option( 'woocommerce_myaccount_page_id' ) ) ); ?>">
                        ...
                        <span class="info-tooltip">
                            <?php esc_html_e( 'My Account', 'bosa-educare' ); ?>
                        </span>
                    </a>
                </div>
            </div>
...
* @return array.
*/
function bosa_educare_get_pages(){
...
* @since Bosa Educare 1.0.0
*/
if( !function_exists( 'bosa_educare_blog_advertisement_banner' ) ){
    function bosa_educare_blog_advertisement_banner(){
...
if ( ! function_exists( 'bosa_educare_grid_thumbnail_date' ) ) :
    /**
     * Prints HTML with meta information for the tags and comments.
     */
    function bosa_educare_grid_thumbnail_date() {
                    ...
                    comments_popup_link(
                        sprintf(
                            wp_kses(
                                ...
                                __( 'Comment<span class="screen-reader-text"> on %s</span>', 'bosa-educare' ),
                                array(
                                    'span' => array(
                                        'class' => array(),
                                    ),
...
if( !function_exists( 'bosa_get_intermediate_image_sizes' ) ){
    ...
    */
    function bosa_get_intermediate_image_sizes(){
        ...
        $data   = array(
            'full'          => esc_html__( 'Full Size', 'bosa-educare' ),
            'large'         => esc_html__( 'Large Size', 'bosa-educare' ),
            'medium'        => esc_html__( 'Medium Size', 'bosa-educare' ),
            'medium_large'  => esc_html__( 'Medium Large Size', 'bosa-educare' ),
            'thumbnail'     => esc_html__( 'Thumbnail Size', 'bosa-educare' ),
            '1536x1536'     => esc_html__( '1536x1536 Size', 'bosa-educare' ),
            '2048x2048'     => esc_html__( '2048x2048 Size', 'bosa-educare' ),
            'bosa-1920-550' => esc_html__( '1920x550 Size', 'bosa-educare' ),
            'bosa-1370-550' => esc_html__( '1370x550 Size', 'bosa-educare' ),
            'bosa-590-310'  => esc_html__( '590x310 Size', 'bosa-educare' ),
            'bosa-420-380'  => esc_html__( '420x380 Size', 'bosa-educare' ),
            'bosa-420-300'  => esc_html__( '420x300 Size', 'bosa-educare' ),
            'bosa-420-200'  => esc_html__( '420x200 Size', 'bosa-educare' ),
            'bosa-290-150'  => esc_html__( '290x150 Size', 'bosa-educare' ),
            'bosa-80-60'    => esc_html__( '80x60 Size', 'bosa-educare' ),
        );
...
if( !function_exists( 'bosa_educare_archive_post_layout_filter' ) ){
    /**
    ...
    * @return array
    */
    add_filter( 'bosa_archive_post_layout_filter', 'bosa_educare_archive_post_layout_filter' );
    function bosa_educare_archive_post_layout_filter( $post_layout ){
...
if( !function_exists( 'bosa_educare_footer_layout_filter' ) ){
    /**
    ...
    * @return array
    */
    add_filter( 'bosa_footer_layout_filter', 'bosa_educare_footer_layout_filter' );
    function bosa_educare_footer_layout_filter( $footer_layout ){
        $added_footer = array(
...
* @return array
*/
function bosa_educare_get_product_categories(){
...
if ( ! function_exists( 'bosa_educare_modify_locale' ) ) :
    /**
     ...
     * @return array
     */
    function bosa_educare_modify_locale( $locale ) {
    ...
    add_filter( 'bosa_localize_var', 'bosa_educare_modify_locale' );
endif;

if( !function_exists( 'bosa_educare_transparent_body_class' ) ){
    /**
    ...
    * @return array $class
    */
    function bosa_educare_transparent_body_class( $class ){
    ...
    add_filter( 'body_class', 'bosa_educare_transparent_body_class' );
}
